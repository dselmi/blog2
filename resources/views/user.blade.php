...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">  <!-- Ionicons -->
...
<ul class="treeview-menu">
          ...
          <li class="treeview">
              ...
              <ul class="treeview-menu">
                  <li><a href="{{route('posts.index')}}">liste posts</a></li>
          ...
          <li class="treeview">
              ...
              <ul class="treeview-menu">
                  <li><a href="{{route('category.index')}}">Liste category</a></li>
...
<button type="button" class="btn btn-block btn-danger">Delete</button></td>
               </tr>
               @endforeach
...
<!-- jQuery 3 -->
<script src="https://code.jquery.com/jquery-3.2.0.min.js"></script><!-- Bootstrap 3.3.7 -->
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script><!-- AdminLTE App -->
